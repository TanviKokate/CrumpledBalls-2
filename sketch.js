...
function setup() {
  ...
  leftBody = new Dustbin(643, 385, 20, 180);
  rightBody = new Dustbin(760, 385, 20, 180);
...
function keyPressed(){
  if (keyCode === UP_ARROW){
    Matter.Body.applyForce(paper.body, paper.body.position, {x : 40, y : -88});
  }
}